...
class baseObject extends Config{
  ...
  function sideBar(){
    $arraySideBar = array(
        ...
        array("refMember","
            ...
            "),
        array("refTradePoint","
            <a href='pages.php?page=refTradePoint' title='Trade Point'>
                <i class='glyph-icon icon-shopping-cart'></i>
                <span>Trade Point</span>
            </a>
            "),
        array("refPayment","
            <a href='pages.php?page=refPayment' title='Payment'>
                <i class='glyph-icon icon-money'></i>
                <span>Payment</span>
            </a>
            "),
        array("refNews","
            <a href='pages.php?page=refNews' title='News'>
                <i class='glyph-icon icon-newspaper-o'></i>
                <span>News</span>
            </a>
            "),
        array("logAbsen","
            <a href='pages.php?page=logAbsen' title='Absen'>
                <i class='glyph-icon icon-elusive-group'></i>
                <span>Absen</span>
            </a>
            "),
        array("logAdRequest","
            <a href='pages.php?page=logAdRequest' title='Log Ad Request'>
                <i class='glyph-icon icon-bar-chart-o'></i>
                <span>Log Ad Request</span>
            </a>
            "),
        array("logAdShow","
            <a href='pages.php?page=logAdShow' title='Log Ad Show'>
                <i class='glyph-icon icon-line-chart'></i>
                <span>Log Ad Show</span>
            </a>
            "),
        array("settingAd","
            <a href='pages.php?page=settingAd' title='Setting'>
                <i class='glyph-icon icon-gear'></i>
                <span>Setting</span>
            </a>
            "),
        array("logout","
            <a href='pages.php?page=logout' title='logout'>
                <i class='glyph-icon icon-power-off'></i>
                <span>Logout</span>
            </a>
            "),
  ...
  function putImage($baseImage,$imageLocation){
    ...
    return "http://admin.bpulsa.rm-rf.studio/".$imageLocation;
  }
