  ...
  if(errMsg == '' || errMsg=='Pilih hanya satu data'){
        ...
        function(){
          $.ajax({
              ...
              success: function(data) {
                var resp = eval('(' + data + ')');
                if(resp.err==''){
                  refMember.suksesAlert("Data Terhapus",refMember.daftarRender);
                }else{
                  refMember.errorAlert(resp.err);
                }
              }
	...
	filterRender: function(){
		$.ajax({
			...
			url: refMember.url+'&API=filterRender',
			success: function(data) {
				var resp = eval('(' + data + ')');
				if(resp.err==''){
	...
	daftarRender: function(){
		refMember.showLoading();
		$.ajax({
			type:'POST',
			data : $("#formFilter").serialize(),
			url: refMember.url+'&API=daftarRender',
			success: function(data) {
				refMember.closeLoading();
				var resp = eval('(' + data + ')');
				if(resp.err==''){
