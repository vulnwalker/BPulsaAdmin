<?php
class refNews extends baseObject{
  var $Prefix = "refNews";
  var $formName = "refNewsForm";
  var $tableName = "news";
  var $username = "";
  function jsonGenerator(){
    ...
    foreach ($_POST as $key => $value) {
      ...
      case 'Edit':{
        $content = $this->Edit($refNews_cb[0]);
  		break;
  		}
      case 'saveNew':{
  			if(empty($titleNews)){
      ...
      case 'Hapus':{
        for ($i=0; $i < sizeof($refNews_cb) ; $i++) {
          $query = "delete from $this->tableName where id = '".$refNews_cb[$i]."'";
          $this->sqlQuery($query);
        }
        $cek = $query;
        break;
  ...
  function generateTable($kondisiTable){
    ...
    $no = 1;
    $getDataServer = $this->sqlQuery("select * from news $kondisiTable");
        ...
        <div class='modal-dialog modal-lg'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                  ...
                  <div class='form-group'>
                    <div class='row'>
                      <label class='col-sm-3 control-label' style='margin-top:6px;'>Title</label>
                      <div class='col-sm-9'>
                        ".$this->textBox(array(
                          "id" => 'titleNews',
                        ))."
                  ...
                  <div class='form-group'>
                    <div class='row'>
                      <label class='col-sm-3 control-label' style='margin-top:6px;'>Content</label>
                      <div class='col-sm-9'>
                        ".$this->textArea(array(
                          "id" => 'contentNews',
                        ))."
